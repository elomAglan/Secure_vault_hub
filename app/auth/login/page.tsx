...
export default function UserLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // erreur déjà capturée dans le store
    }
  }
            ...
            <Card className="border-slate-200/60 bg-white p-8 shadow-2xl shadow-slate-200/50 rounded-[2rem]">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {error && (
                  ...
                  >
                    {error.includes('403') || error.toLowerCase().includes('credential') 
              ...
              {/* SOCIAL LOGINS */}
                    <div className="grid grid-cols-2 gap-4">
                      <Button
                        variant="outline"
                        type="button"
                        asChild // Permet d'utiliser le lien <a> avec le style du Button
